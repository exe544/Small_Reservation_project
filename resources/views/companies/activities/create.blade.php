            ...
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="overflow-hidden overflow-x-auto border-b border-gray-200 bg-white p-6">
                    <form action="{{ route('companies.activities.store', $company) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            <x-input-label for="start_date" value="Start time" />
                            <x-text-input id="start_date" name="start_date" value="{{ old('start_date') }}" type="datetime-local" class="mt-1 block w-full" />
