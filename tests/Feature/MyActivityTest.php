...
class MyActivityTest extends TestCase
{
    ...
    {
        $user = User::factory()->create();
        $activity = Activity::factory()->withCompanyAndGuide()->create(['start_date' => now()->addWeek()]);
        $activity2 = Activity::factory()->withCompanyAndGuide()->create(['start_date' => now()->addMonth()]);
        $activity3 = Activity::factory()->withCompanyAndGuide()->create(['start_date' => now()->addMonths(2)]);
        ...
        $user->activities()->attach($arrayActivities);
